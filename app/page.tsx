...
import { DEFAULT_HOME_BANNERS } from "@/lib/banners";
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-zinc-50 pb-20">
      ...
      <HeroBanner banners={DEFAULT_HOME_BANNERS} intervalMs={3000} />
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2">
                  ...
                  <div className="h-1 bg-zinc-100 rounded-full overflow-hidden">
                    <div className="h-full bg-zinc-900 rounded-full" style={{ width: `${((ev.max - ev.slots) / ev.max) * 100}%` }}></div>
                  </div>
                </div>
              </div>
            </Link>
